                        ...
                        <div className='d-flex justify-content-between w-100 align-items-center'>
                            <div className="d-flex" style={{ color: "#fafafa" }}>
                                <div className='m-auto d-flex'>
                                    {isTaskTabCompleted ?
                                    <CheckCircleRoundedIcon onClick={(event) => handleTaskComplete(event,index)} style={{color: "#048a66"}} className='user-home-task-check-icon user-home-task-set-complete' />
                                    :
